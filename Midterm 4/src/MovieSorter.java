...
public class MovieSorter {
  ...
  /**
   * Reorganizes an array of Movie values into a valid max heap. This heapify operation does NOT
   * operate in-place.
   * 
  ...
  private static Movie[] heapify(Movie[] values, int size) {
    ...
    // TODO #4: replace with index of last internal node in values
    int heapifyIndex = (size / 2);
    heapifyIndex--;
