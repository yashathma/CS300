...
public class MultipleChoiceQuestion {
  ...
  /**
   * Creates a new MultipleChoiceQuestion (MCQ) with the provided information. We assume that 
   * title, question, and answers are valid. When created, a MCQ is NOT yet answered.
   * 
   ...
   * @throws IndexOutOfBoundsException with a descriptive error message if correctAnswerIndex is
   *                                   out of the range 1 .. answers.length inclusive
   * @throws IllegalArgumentException  with a descriptive error message if pointsPossible is less
   *                                   or equal to zero
   */
   ...
   * 
   * 1. oversize array 2. perfect size array
   * 
   ...
   * @throws IllegalArgumentException with a descriptive error message if pointsPossible is
   *  negative or zero
   */
  public void setPointsPossible(int pointsPossible) {
    if (pointsPossible <= 0)
      throw new IllegalArgumentException(
          pointsPossible + " is an invalid value for points possible");
    this.pointsPossible = pointsPossible;
  }
   ...
   * @throws IndexOutOfBoundsException with a descriptive error message if studentAnswerIndex is 
   * out of the range 0..answers.length-1 inclusive
   */
